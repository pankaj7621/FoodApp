...
import { HorizontalFoodCard, VerticalFoodCart } from "../../components";
...
const Home = () => {
  ...
  function handleChangeCategory(categoryId, menuTypeId) {
    ...
    // Set the popular menu base on categoryId
    setPopular(
      selectedPopular?.list.filter((a) => a.categories.includes(categoryId))
    );

    // Set the recommended menu based on menu id
    setRecommends(
          ...
          renderItem={({ item, index }) => (
            <HorizontalFoodCard
              containerStyle={{
                ...
                marginLeft: index == 0 ? SIZES.padding : SIZES.padding * 2.5,
